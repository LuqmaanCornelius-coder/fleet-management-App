...
const DriverLogin = () => {
  ...
  const [email, setEmail] = useState('driver@fleetapp.test');
  ...
  return (
    <div className="min-h-screen bg-slate-950 px-4 py-12 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-md rounded-3xl border border-slate-800 bg-slate-900/90 p-8 shadow-xl shadow-slate-950/40">
        <h1 className="text-3xl font-semibold">Driver Sign In</h1>
        <p className="mt-2 text-slate-400">Access your trips, safety checks, and incident reporting tools.</p>
